...
/**
 * @dev This contract stores all data related to subscriptions of the fixed recurring billing model.
 */
contract FixedRecurringSubscriptionsDatabase is IFixedRecurringSubscriptionsDatabase, Database, AccessControl {
    /**
